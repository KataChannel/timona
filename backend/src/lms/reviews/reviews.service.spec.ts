...
describe('ReviewsService', () => {
  ...
  describe('createReview', () => {
    ...
    it('should throw BadRequestException if user not enrolled', async () => {
      ...
      await expect(
        service.createReview('user-1', { courseId: 'course-1', rating: 5 } as any),
      ).rejects.toThrow(
        new BadRequestException('You must be enrolled in this course to leave a review'),
      );
    });
    ...
    it('should throw BadRequestException if user already reviewed', async () => {
      ...
      await expect(
        ...
        new BadRequestException('You have already reviewed this course. Use update instead.'),
      );
    });
    ...
    it('should update course rating after creating review', async () => {
      ...
      await service.createReview('user-1', { courseId: 'course-1', rating: 5 } as any);
  ...
  describe('updateReview', () => {
    ...
    it('should throw NotFoundException if review not found', async () => {
      ...
      await expect(
        service.updateReview('user-1', { reviewId: 'non-existent', rating: 5 }),
    ...
    it('should throw ForbiddenException if user is not review owner', async () => {
      ...
      await expect(
        service.updateReview('user-1', { reviewId: 'review-1', rating: 5 }),
      ).rejects.toThrow(new ForbiddenException('You can only update your own reviews'));
    });
  ...
  describe('deleteReview', () => {
    ...
    it('should throw NotFoundException if review not found', async () => {
      ...
      await expect(service.deleteReview('user-1', 'non-existent')).rejects.toThrow(
    ...
    it('should throw ForbiddenException if user is not review owner', async () => {
      ...
      await expect(service.deleteReview('user-1', 'review-1')).rejects.toThrow(
  ...
  describe('getReviewStats', () => {
    it('should calculate review statistics correctly', async () => {
      ...
      expect(result.avgRating).toBe(3.6); // (5+5+4+3+1)/5 = 3.6
  ...
  describe('markReviewHelpful', () => {
    ...
    it('should throw NotFoundException if review not found', async () => {
      ...
      await expect(service.markReviewHelpful('user-1', 'non-existent')).rejects.toThrow(
        new NotFoundException('Review not found'),
      );
    });
  });
