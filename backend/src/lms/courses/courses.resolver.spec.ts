...
import { UserRoleType, CourseStatus } from '@prisma/client';
  ...
  describe('Mutations - Course', () => {
    describe('createCourse', () => {
      it('should create a new course', async () => {
        ...
        const result = await resolver.createCourse(mockUser, createInput as any);
    ...
    describe('archiveCourse', () => {
      it('should archive a course', async () => {
        const archivedCourse = { ...mockCourse, status: CourseStatus.ARCHIVED };
  ...
  describe('Mutations - Modules', () => {
    ...
    describe('reorderModules', () => {
      it('should reorder modules', async () => {
        ...
        const result = await resolver.reorderModules(mockUser, reorderInput as any);
  ...
  describe('Mutations - Lessons', () => {
    ...
    describe('createLesson', () => {
      it('should create a new lesson', async () => {
        ...
        const result = await resolver.createLesson(mockUser, createInput as any);
    ...
    describe('reorderLessons', () => {
      it('should reorder lessons', async () => {
        ...
        const result = await resolver.reorderLessons(mockUser, reorderInput as any);
